...
g2_dat$x2 = g2_dat$N_dead_comb/g2_dat$N_total
...
######################################################
##
## Repeat the process for PBO ITNs
##
#######################################################
...
mean(betbin_samples2$alpha_1)
mean(betbin_samples2$alpha_2)
